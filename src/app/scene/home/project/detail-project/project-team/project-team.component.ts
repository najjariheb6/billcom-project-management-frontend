...
export class ProjectTeamComponent implements OnInit {
    ...
    constructor(public router: Router, private dialogService: DialogconfirmService, private projectService: ProjectService, private notifyService: NotficationService) {
    }
    ...
    goToTeamDetails(id: any) {
        ...
        let aa = encodeURIComponent(id + '/' + this.idProject);
