...
@NgModule({
  declarations: [
    ...
    DelayedDashboardProjectsComponent,
    SpeceficDashboardProjectComponent,
    TaskDateComponent,
    TaskDateListComponent,
    ProjectLeaderHomeComponent,
    ProjectLeaderListComponent,
    ListTaskTeamComponent,
    ChatComponent,
    ListEventComponent,
    AddEventComponent,
    UpdateEventComponent,
    DetailEventComponent,
    ProjectChargeDetailComponent,
    NotificationComponent,
    RemindComponent,
    DashboardPLProjectsComponent,
    DelayedDashboardProjectLeaderComponent,
    SpeceficDashboardProjectLeaderComponent,
    ChargeDashboardProjectLeaderComponent,
    SortProjectPipe,
    SortNotificationPipe,
    SortEmployeePipe,
    SortProjectLeaderPipe,
