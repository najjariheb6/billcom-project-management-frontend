...
export class NewEmployeeComponent implements OnInit {
    @Input()
    titleEmployee: String = 'Create Employee'
    ...
    currentTime: any;
    list1: Role[];
    constructor(private formBuilder: FormBuilder, private employeeService: EmployeeServiceService,private roleService: RoleService
        , private notifyService: NotficationService, public dialogRef: MatDialogRef<NewEmployeeComponent>) { }
    ...
    onSubmit() {
        ...
        if(this.form!= undefined){
            this.employeeService.save(employee, this.form).subscribe(
                data => {
                ...
                this.employeeService.saveWithoutPhoto(employee).subscribe(
                    data => {
