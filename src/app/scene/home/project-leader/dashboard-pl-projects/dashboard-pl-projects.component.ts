...
@Component({
  selector: 'app-dashboard-pl-projects',
  templateUrl: './dashboard-pl-projects.component.html',
  styleUrls: ['./dashboard-pl-projects.component.scss']
})
export class DashboardPLProjectsComponent implements OnInit {
 ...
 constructor(private projectService: ProjectService) { }
  ...
  ngOnInit(): void {
    this.projectService.getProjectsProjectLeaderTimeGap().subscribe((data) => {
