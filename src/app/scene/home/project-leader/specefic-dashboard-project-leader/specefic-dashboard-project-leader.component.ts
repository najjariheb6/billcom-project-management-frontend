...
@Component({
  selector: 'app-specefic-dashboard-project-leader',
  templateUrl: './specefic-dashboard-project-leader.component.html',
  styleUrls: ['./specefic-dashboard-project-leader.component.scss']
})
export class SpeceficDashboardProjectLeaderComponent implements OnInit {
