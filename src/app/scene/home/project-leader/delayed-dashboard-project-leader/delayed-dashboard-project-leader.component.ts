...
@Component({
  selector: 'app-delayed-dashboard-project-leader',
  templateUrl: './delayed-dashboard-project-leader.component.html',
  styleUrls: ['./delayed-dashboard-project-leader.component.scss']
})
export class DelayedDashboardProjectLeaderComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.projectService.getProjectLeaderDealyedDelevered().subscribe((data) => {
