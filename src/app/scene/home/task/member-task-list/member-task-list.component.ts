...
@Component({
    selector: 'app-member-task-list', templateUrl: './member-task-list.component.html', styleUrls: ['./member-task-list.component.scss']
})
export class MemberTaskListComponent implements OnInit {
    ...
    getListTask() {
        ...
        this.taskGroupsSubscription = this.tasksService.listTasksByTeamMember(this.id).subscribe((data) => {
            this.tasks = data;
        });
    }
    ...
    getProjectDetail() {
        ...
        this.teamService.projectTeamDetail(this.id).subscribe(data => {
            this.project = data;
    ...
    onSubmit() {
        this.tasksService.addStatus(this.statusForm.value.status).subscribe(data => {
    ...
    getTeamDetail() {
        ...
        this.tasksService.getTeamSpecefic(this.id).subscribe((data) => {
            this.team = data;
        });
    }
