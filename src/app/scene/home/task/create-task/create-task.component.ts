...
@Component({
    selector: 'app-create-task', templateUrl: './create-task.component.html', styleUrls: ['./create-task.component.scss']
})
export class CreateTaskComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.addTaskForm = this.formBuilder.group({
            ...
            validator: [dateValidator('deleveryDate'), dueDateValidator('startedDate', 'deleveryDate'), dateValidator('startedDate')]
        });
    ...
    getList(): void {
        this.taskService.findAllStatus().subscribe((data: Status[]) => {
